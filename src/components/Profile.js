...
const Profile = () => {
  ...
  data-aos-once="false"
  class="w-[335.73px] h-[335.73px] p-5 sm:max-w-xs md:max-w-sm lg:max-w-md lg:mr-10 xl:mr-20 lg:p-5 lg:w-[335.73px] lg:h-[335.73px] sm:w-[335.73px]"
>
  <img
    class="w-full h-full object-cover object-center bg-[#b9aeb6] border-2 border-white pointer-events-none rounded-full backdrop-contrast-200 backdrop-brightness-200"
